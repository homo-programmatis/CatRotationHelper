...
function g_Addon.SettingsUI_Initialize()
	...
	CatRotationHelper_ChkOptionsCat:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsCat_OnClick);
	...
	CatRotationHelper_ChkOptionsClearcast:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsClearcast_OnClick);
	...
	CatRotationHelper_ChkOptionsCatCombo:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsCatCombo_OnClick);
	...
	CatRotationHelper_ChkOptionsCatBerserk:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsCatBerserk_OnClick);
	...
	CatRotationHelper_ChkOptionsCatPredators:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsCatPredators_OnClick);
	...
	CatRotationHelper_ChkOptionsCatCharge:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsCatCharge_OnClick);
	...
	CatRotationHelper_ChkOptionsCatSurvival:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsCatSurvival_OnClick);

	------------------------------------------------------------

	CatRotationHelper_ChkOptionsBearText:SetText("Enable Bear Frames");
	CatRotationHelper_ChkOptionsBear:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsBear_OnClick);
	...
	CatRotationHelper_ChkOptionsBearLacerate:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsBearLacerate_OnClick);
	...
	CatRotationHelper_ChkOptionsBearBerserk:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsBearBerserk_OnClick);
	...
	CatRotationHelper_ChkOptionsBearSurvival:SetScript("OnClick", g_Addon.SettingsUI_ChkOptionsBearSurvival_OnClick);
...
function g_Addon.SettingsUI_ChkOptionsCat_OnClick(self)
...
function g_Addon.SettingsUI_ChkOptionsClearcast_OnClick(self)
	if(self:GetChecked()) then
...
function g_Addon.SettingsUI_ChkOptionsCatCombo_OnClick(self)
	if(self:GetChecked()) then
		crhCp = true
...
function g_Addon.SettingsUI_ChkOptionsCatBerserk_OnClick(self)
	if(self:GetChecked()) then
...
function g_Addon.SettingsUI_ChkOptionsCatPredators_OnClick(self)
	if(self:GetChecked()) then
...
function g_Addon.SettingsUI_ChkOptionsCatCharge_OnClick(self)
	if(self:GetChecked()) then
...
function g_Addon.SettingsUI_ChkOptionsCatSurvival_OnClick(self)
	if(self:GetChecked()) then
...
function g_Addon.SettingsUI_ChkOptionsBear_OnClick(self)
	if(self:GetChecked()) then
		crhShowBear = true
...
function g_Addon.SettingsUI_ChkOptionsBearLacerate_OnClick(self)
	if(self:GetChecked()) then
		crhLacCounter = true
...
function g_Addon.SettingsUI_ChkOptionsBearBerserk_OnClick(self)
	if(self:GetChecked()) then
...
function g_Addon.SettingsUI_ChkOptionsBearSurvival_OnClick(self)
	if(self:GetChecked()) then
